...
function NavigationPopup({ onClose }) {
  const activeStyle = {
    // Для стилей активной ссылки NavLink
      ...
      <div className="navigation-popup__container">
        ...
        <nav className="navigation-popup__links-container">
          <div className="navigation__films navigation__films_popup">
            <NavLink
              to="/"
              className="navigation-popup__homepage"
            ...
            <NavLink
              to="movies"
              className="navigation__movies navigation__movies_popup"
              style={({ isActive }) => (isActive ? activeStyle : undefined)}
            >
              Фильмы
            </NavLink>
          ...
          <NavLink
            to="/profile"
            className="navigation__account navigation__account_popup"
            style={({ isActive }) => (isActive ? activeStyle : undefined)}
          >
            <p
              to="/profile"
              className="navigation__account-link navigation__account-link_popup"
            >
              Аккаунт
            </p>
            <img
